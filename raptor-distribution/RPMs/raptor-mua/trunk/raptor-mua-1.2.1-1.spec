...
install -d %{buildroot}/opt/raptor/mua/batchimport/openathensla
install -d %{buildroot}/opt/raptor/mua/batchimport/radius-moonshot-idp
install -d %{buildroot}/opt/raptor/mua/batchimport/radius-eduroam-idp
...
# Create directory for logrotate config
...
cp -r %{_builddir}/%{name}-%{version}/misc/logrotate-raptormua.conf %{buildroot}/etc/logrotate.d/raptormua
...
%dir /opt/raptor/mua/batchimport/openathensla
%dir /opt/raptor/mua/batchimport/radius-moonshot-idp
%dir /opt/raptor/mua/batchimport/radius-eduroam-idp
...
%config(noreplace) /opt/raptor/mua/conf/event-release.xml
...
%config            /etc/logrotate.d/raptormua
...
%changelog
* Tue Feb 25 2014  Rhys Smith <smith@cardiff.ac.uk>  1.2.1-1
- Some bugfixes for the (unreleased) v1.2.0. See release notes for details.

* Mon Jul 8 2013  Rhys Smith <smith@cardiff.ac.uk>  1.2.0-1
- First release of v1.2. See release notes for details.

* Wed Sep 12 2012  Rhys Smith <smith@cardiff.ac.uk>  1.1.4-1
- Some more bug fixes, to v1.1.3. See release notes for details.
