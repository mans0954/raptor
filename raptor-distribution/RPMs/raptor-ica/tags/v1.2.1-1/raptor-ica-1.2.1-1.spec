...
cp -r %{_builddir}/%{name}-%{version}/misc/logrotate-raptorica.conf %{buildroot}/etc/logrotate.d/raptorica
...
%config(noreplace) /opt/raptor/ica/conf/event-parse.xml
%config(noreplace) /opt/raptor/ica/conf/event-parse-formats-custom.xml
%config            /opt/raptor/ica/conf/event-parse-formats-system.xml
...
%config            /etc/logrotate.d/raptorica
...
- Bugfix to v1.1.0. See release notes for details.
...
- Minor bugfix to v1.0.0 - modified initscript only.
