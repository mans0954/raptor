...
public class EntryMetadata {
    ...
    /**
     * used if a persistant db primary key is required, only one entrymetadata so only id of one needed
     */
    ...
    /**
     * stores the list of latest unique entries as their hash code (for easy persisting). That is, those with the latest
     * and same DateTime, but different hashcode (attribute values).
     */
