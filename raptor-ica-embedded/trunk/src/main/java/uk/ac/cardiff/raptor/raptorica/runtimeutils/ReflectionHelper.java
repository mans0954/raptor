 ...
 *
 */
package uk.ac.cardiff.raptor.raptorica.runtimeutils;
...
import uk.ac.cardiff.raptor.raptorica.parse.external.file.LogFileParser;
...
public class ReflectionHelper {
    ...
    /**
     * Checks if an attribute exists on a class by finding if it has a 'get' method
     * associated on the class
     *
     * @param entry
     * @param attributeID
     */
