 ...
 */
package uk.ac.cardiff.raptor.raptorica.dao.internal;
...
import uk.ac.cardiff.raptor.raptorica.model.PersistantEntryHandler;
...
public class ICADataConnectionImpl implements ICADataConnection{
    ...
    /* class logger */
    static Logger log = Logger.getLogger(ICADataConnectionImpl.class);
