...
public class ResourceClassificationBackgroundService implements SaveAndApplyResourceClassificationCallbackInterface {
    ...
    public ResourceClassificationBackgroundService(RaptorDataConnection dataConnection) {
    ...
    public void saveResourceMetadataAndApplyAsync(List<ResourceMetadata> resourceMetadata) {
        ...
        SaveAndApplyResourceClassificationTask storeEntryTask =
                new SaveAndApplyResourceClassificationTask(dataConnection, resourceMetadata, this);
