...
public class ReleaseInformation {
    ...
    /** Unique identifier for the persistence layer. */
    ...
    /**
     * Stores a set of the latest equal entries hashcodes. That is, those with the latest and same DateTime, but
     * different state (field values).
     */
    private Set<Integer> latestEqualEntries;

    /**
     * This field is the primary key of this releaseInformation instance that is used to store and retrieve this object.
     */
    private String serviceEndpoint;

    /**
     * Default constructor. Instantiate the <code>Set</code> <code>latestEqualEntries</code>
     */
    ...
    /**
     * After a release has been performed, this method is called with the events that were released. The
     * <code>lastReleasedEventTime</code> and <code>latestEqualEntries</code> are then set accordingly. The latest
     * events are selected chronologically by the <code>eventTime</code> field of each <code>event</code> from the
     * <code>releasedEvents</code>.
     * 
    ...
    /**
     * Returns true if the event is either: 1. Chronologically after the lastReleasedEventTime 2. Is equal to the
     * lastReleasedEventTime but is not in the set <code>latestEqualEntries</code>
     * 
     * In effect, the event can be released if it occurred after all other events that have already been released to
     * this endpoint, or occurred at the same time but was not an event that was already sent.
     * 
    ...
    /**
     * @param lastReleasedEventTime the lastReleasedEventTime to set
     */
    ...
    /**
     * @return the lastPublishedEntryTime if its not null, otherwise a new datetime set to EPOCH is returned
     *         (1970-01-01T00:00)
     */
