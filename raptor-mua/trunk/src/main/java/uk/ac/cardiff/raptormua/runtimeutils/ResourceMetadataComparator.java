...
public class ResourceMetadataComparator implements Comparator<ResourceMetadata> {
    ...
    /**
     * Compares the <code>resourceId</code> from two <code>ResourceMetadata</code> instances. First it removes the
     * protocol from the <code>resourceId</code> URL. Hence, it compares the hostname and path only.
     */
    @Override
