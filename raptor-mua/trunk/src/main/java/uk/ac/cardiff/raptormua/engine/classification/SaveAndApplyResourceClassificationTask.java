...
public class SaveAndApplyResourceClassificationTask implements Callable<Boolean> {
    ...
    public SaveAndApplyResourceClassificationTask(EventHandler entryHandler, List<ResourceMetadata> resourceMetadata,
            SaveAndApplyResourceClassificationCallbackInterface callback) {
