...
public class PersistantEntryHandler implements EntryHandler {
     ...
     * should never be used as memory overhead is too high for large databases*/
    Set<Entry> entries;
    ...
    /**
     * This method loads all <code>Entries</code> in the <code>entries</code> variable.
     * This method is often not used as large datasets will require vast amounts of memory
     */
