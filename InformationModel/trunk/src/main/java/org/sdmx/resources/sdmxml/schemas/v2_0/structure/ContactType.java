...
public class ContactType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "URI", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class),
        @XmlElementRef(name = "Email", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class),
        @XmlElementRef(name = "X400", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class),
        @XmlElementRef(name = "Telephone", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class),
        @XmlElementRef(name = "Fax", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class)
    })
