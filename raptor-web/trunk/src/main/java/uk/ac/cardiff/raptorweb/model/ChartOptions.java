...
public class ChartOptions implements Serializable {
    ...
    public enum LabelPositionType {
        ...
        DOWN_45(CategoryLabelPositions.DOWN_45, "45 Degree Down"), DOWN_90(CategoryLabelPositions.DOWN_90,
                "90 Degree Down"), STANDARD(CategoryLabelPositions.STANDARD, "Standard");
    ...
    public enum ChartType {
        LINE("Line Graph"), BAR("Bar Graph"), AREA("Area Graph"), BAR3D("3D Bar Graph"), LINE3D("3D Line Graph");
